...
const createMockedBlock = (
  ...
  return new RhythmBlock({
    ...
    durationInMinutes: durations[category],
...
const getMockedConstraints = (
  ...
  switch (category) {
    case "meal":
      ...
      return [
        { type: "window", start: lunchStart, end: lunchEnd },
        { type: "duration", maxDurationInMinutes: 60 },
      ];
    ...
    case "exercise":
      ...
      return [
        ...
        { type: "before", deadline: exerciseDeadline },
        { type: "duration", maxDurationInMinutes: 45 },
      ];
    ...
    case "focus":
      ...
      return [
        ...
        { type: "duration", maxDurationInMinutes: 90 },
      ];

    case "rest":
      return [
        { type: "natural-language", description: "When I need a break" },
        { type: "duration", maxDurationInMinutes: 30 },
      ];
    ...
    case "hobby":
      ...
      return [
        ...
        { type: "duration", maxDurationInMinutes: 120 },
      ];

    case "connect":
      // Social time in evening, natural language
      return [
        { type: "natural-language", description: "When others are available" },
        {
          type: "window",
    ...
    case "chore":
      return [
        { type: "natural-language", description: "When I have time" },
        { type: "duration", maxDurationInMinutes: 45 },
      ];
    ...
    case "break":
      return [
        ...
        { type: "duration", maxDurationInMinutes: 15 },
      ];
